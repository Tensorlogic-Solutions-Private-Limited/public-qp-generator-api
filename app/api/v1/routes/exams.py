...
from app.services.exam_service import create_exam_design_and_generate_qps,update_design_service
...
async def create_question_papers(
    ...
    """
    try:
        return await create_exam_design_and_generate_qps(payload, current_user, db)
...
async def put_exam_design(
    ...
    """
        ...
        """
    return await update_design_service(db, exam_code, payload, current_user)
